...
[Anonymous public-access verification](public-access.json) confirms public visibility, the published handoff commit on `main`, readable handoff content, the frozen runtime commit, and the public simulator commit. All five HTTPS checks returned 200 without supplied credentials. This is a point-in-time check, not a guarantee of future availability.
